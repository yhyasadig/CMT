...
try {
    ...
    echo "<div class='error-message'>حدث خطأ في الاتصال بقاعدة البيانات: " . htmlspecialchars($e->getMessage()) . "</div>";
    exit();
}
    ...
    try {
        ...
        if ($task && $task['assigned_to'] == $uploadedBy) {
            ...
            if ($result === true) {
                ...
                echo "<div class='error-message'>حدث خطأ في رفع الملف: " . htmlspecialchars($result) . "</div>";
            }
        } else {
        ...
        <tr>
            ...
            <td>
                ...
                try {
                    ...
                    // استرجاع اسم المشرف مرة واحدة خارج اللوب
                ...
                ?>
                    <div class="comment">
                        ...
                        <div class="comment-text">التقييم: <?php echo htmlspecialchars($rating['score']); ?>/100</div>
                        <div class="comment-timestamp"><?php echo htmlspecialchars($rating['timestamp']); ?></div>
                    </div>
                <?php
                    endforeach;
                } catch (Exception $e) {
