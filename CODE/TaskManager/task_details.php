...
try {
    ...
    $message = "حدث خطأ أثناء جلب بيانات المهمة: " . $e->getMessage();
}
?>
...
<div class="container">
    ...
    <!-- عرض رسالة في حالة عدم وجود المهمة أو وجود خطأ -->
    <?php if ($message): ?>
        <p class="message"><?php echo htmlspecialchars($message); ?></p>
    <?php else: ?>
        <div class="task-detail">
            <p><label>عنوان المهمة:</label> <?php echo htmlspecialchars($taskDetails['title']); ?></p>
            <p><label>وصف المهمة:</label> <?php echo htmlspecialchars($taskDetails['description']); ?></p>
            <p><label>المكلف بالمهمة:</label> 
                ...
                try {
                    ...
                    echo htmlspecialchars($user['name'] ?? 'غير معروف');
                } catch (Exception $e) {
                    echo "حدث خطأ في جلب اسم المكلف: " . htmlspecialchars($e->getMessage());
                }
                ?>
            </p>
            <p><label>تاريخ التسليم:</label> <?php echo htmlspecialchars($taskDetails['due_date']); ?></p>
            <p><label>الحالة:</label> <?php echo htmlspecialchars($taskDetails['status']); ?></p>
        </div>
    <?php endif; ?>
</div>
